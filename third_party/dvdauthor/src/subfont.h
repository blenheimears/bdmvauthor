...
static void render_one_glyph(font_desc_t *desc, int c) { (void)desc; (void)c; }
static int kerning(font_desc_t *desc, int prevc, int c) { (void)desc; (void)prevc; (void)c; return 0; }
