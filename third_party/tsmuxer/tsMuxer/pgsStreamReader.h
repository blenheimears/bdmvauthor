...
class PGSStreamReader final : public AbstractStreamReader
{
   public:
    ...
    const CodecInfo& getCodecInfo() override { return m_interactiveGraphics ? igsCodecInfo : pgsCodecInfo; }
    ...
    void setInteractiveGraphics(bool value) { m_interactiveGraphics = value; }
